...
export default {
  ...
  data() {
    return {
      ...
      data: {
        ...
        company_phone: this.detail?.company_phone,
        company_fax: this.detail?.company_fax,
        company_address: this.detail?.company_address,
        company_tax_code: this.detail?.company_tax_code,
        company_rep: this.detail?.company_rep,
        company_rep_role: this.detail?.company_rep_role,
        assistant_name: this.detail?.assistant_name,
        assistant_phone: this.detail?.assistant_phone,
        assistant_email: this.detail?.assistant_email,
  ...
  methods: {
    ...
    async submit() {
      ...
      await this.$store.dispatch('updateGuest', submitData);
